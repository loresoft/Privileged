...
/// <summary>
/// An <see cref="PrivilegeContext"/> builder extension methods
/// </summary>
public static class PrivilegeBuilderExtensions
{
    ...
    /// </summary>
    /// <param name="builder">The <see cref="PrivilegeContext"/> builder.</param>
    ...
    /// </returns>
    public static PrivilegeBuilder Allow(this PrivilegeBuilder builder, IEnumerable<string> actions, IEnumerable<string> subjects, IEnumerable<string>? fields = null)
    {
        if (builder == null)
    ...
    /// The builder for chaining method calls
    /// </returns>
    public static PrivilegeBuilder Allow(this PrivilegeBuilder builder, IEnumerable<string> actions, string subject, IEnumerable<string>? fields = null)
    {
        if (builder == null)
            throw new ArgumentNullException(nameof(builder));
    ...
    /// The builder for chaining method calls
    /// </returns>
    public static PrivilegeBuilder Allow(this PrivilegeBuilder builder, string action, IEnumerable<string> subjects, IEnumerable<string>? fields = null)
    {
        if (builder == null)
            throw new ArgumentNullException(nameof(builder));
    ...
    /// The builder for chaining method calls
    /// </returns>
    public static PrivilegeBuilder Forbid(this PrivilegeBuilder builder, IEnumerable<string> actions, IEnumerable<string> subjects, IEnumerable<string>? fields = null)
    {
        if (builder == null)
            throw new ArgumentNullException(nameof(builder));
    ...
    /// The builder for chaining method calls
    /// </returns>
    public static PrivilegeBuilder Forbid(this PrivilegeBuilder builder, IEnumerable<string> actions, string subject, IEnumerable<string>? fields = null)
    {
        if (builder == null)
            throw new ArgumentNullException(nameof(builder));
    ...
    /// The builder for chaining method calls
    /// </returns>
    public static PrivilegeBuilder Forbid(this PrivilegeBuilder builder, string action, IEnumerable<string> subjects, IEnumerable<string>? fields = null)
    {
        if (builder == null)
            throw new ArgumentNullException(nameof(builder));
