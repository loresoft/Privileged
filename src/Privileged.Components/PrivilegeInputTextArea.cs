...
/// <summary>
/// A custom input text area component that integrates privilege-based access control with forms.
...
/// <remarks>
/// <para>
/// This component extends the standard <see cref="InputTextArea"/> component to provide privilege-aware
...
/// <item><description>Inherits all standard InputTextArea functionality when permissions are granted</description></item>
/// </list>
/// <para>
...
/// <example>
/// <code>
/// &lt;PrivilegeInputTextArea @bind-Value="model.Description" 
///                          Subject="Document" 
///                          Field="Description" 
///                          rows="5" /&gt;
/// </code>
...
public class PrivilegeInputTextArea : InputTextArea
{
    ...
    /// </value>
    /// <remarks>
    /// The subject typically represents the entity or resource type being accessed (e.g., "Document", "Article", "Comment").
    /// </remarks>
    [Parameter]
    ...
    /// representing the specific field or property being accessed (e.g., "Description", "Content", "Notes").
    /// </remarks>
    [Parameter]
    ...
    /// </value>
    /// <remarks>
    /// This action is used to determine if the user can view the text area's content.
    ...
    /// </value>
    /// <remarks>
    /// This action is used to determine if the user can modify the text area's content.
    ...
    /// instead of showing the actual text area content.
    /// </remarks>
    ...
    /// </list>
    /// <para>
    /// If the user lacks update permission, a readonly attribute is automatically added to the text area.
    ...
    /// </para>
    /// <list type="bullet">
    /// <item><description><strong>Has read permission:</strong> Renders the standard <see cref="InputTextArea"/> component with all inherited functionality</description></item>
    /// <item><description><strong>No read permission:</strong> Renders a disabled password input field that hides the actual content</description></item>
    /// </list>
    /// <para>
    ...
    /// a text area to maintain security while providing visual feedback that content exists but is restricted.
    /// </para>
    /// </remarks>
