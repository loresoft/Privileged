...
/// <summary>
/// A custom input text component that integrates privilege-based access control with Blazor forms.
...
/// <item><description>Renders a password input field when read permission is denied</description></item>
...
/// <example>
/// <code>
/// &lt;PrivilegeInputText @bind-Value="model.FirstName" 
///                      Subject="User" 
///                      Field="FirstName" /&gt;
/// </code>
/// </example>
...
public class PrivilegeInputText : InputText
{
    /// <summary>
    ...
    /// <summary>
    /// Gets a value indicating whether the user has read permission for the input field.
    /// </summary>
    /// <value>
    ...
    /// instead of showing the actual field value.
    /// </remarks>
    protected bool HasReadPermission { get; set; }

    /// <summary>
    /// Gets a value indicating whether the user has update permission for the input field.
    /// </summary>
    /// <value>
    ...
    /// </para>
    /// <list type="bullet">
    /// <item><description><strong>Has read permission:</strong> Renders the standard <see cref="InputText"/> component with all inherited functionality</description></item>
    /// <item><description><strong>No read permission:</strong> Renders a disabled password input field that hides the actual value</description></item>
    /// </list>
    /// <para>
