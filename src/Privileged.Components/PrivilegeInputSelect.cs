...
/// <summary>
/// A custom input select component that integrates privilege-based access control.
/// </summary>
/// <typeparam name="TValue">The type of the value bound to the input select.</typeparam>
