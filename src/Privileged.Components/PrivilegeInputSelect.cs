...
/// <summary>
/// A custom input select component that integrates privilege-based access control with forms.
...
/// </summary>
/// <typeparam name="TValue">The type of the value bound to the input select. This must be a valid type for HTML select elements.</typeparam>
/// <remarks>
/// <para>
/// This component extends the standard <see cref="InputSelect{TValue}"/> component to provide privilege-aware
...
/// <item><description>Inherits all standard InputSelect functionality when permissions are granted</description></item>
/// </list>
/// <para>
...
/// <seealso cref="InputSelect{TValue}"/>
public class PrivilegeInputSelect<TValue> : InputSelect<TValue>
{
    /// <summary>
    ...
    /// </value>
    /// <remarks>
    /// The subject typically represents the entity or resource type being accessed (e.g., "Order", "User", "Product").
    /// </remarks>
    [Parameter]
    ...
    /// representing the specific field or property being accessed (e.g., "Status", "Category", "Priority").
    /// </remarks>
    [Parameter]
    ...
    /// </value>
    /// <remarks>
    /// This action is used to determine if the user can view the select element's options and current value.
    ...
    /// </value>
    /// <remarks>
    /// This action is used to determine if the user can change the selected value.
    ...
    /// <summary>
    /// Gets a value indicating whether the user has read permission for the select element.
    /// </summary>
    /// <value>
    ...
    /// instead of showing the actual select element and its options.
    /// </remarks>
    protected bool HasReadPermission { get; set; }

    /// <summary>
    /// Gets a value indicating whether the user has update permission for the select element.
    /// </summary>
    /// <value>
    ...
    /// </value>
    /// <remarks>
    /// When this property is <c>false</c>, the component adds a disabled attribute to prevent selection changes,
    ...
    /// </list>
    /// <para>
    /// If the user lacks update permission, a disabled attribute is automatically added to the select element.
    ...
    /// </para>
    /// <list type="bullet">
    /// <item><description><strong>Has read permission:</strong> Renders the standard <see cref="InputSelect{TValue}"/> component with all inherited functionality and child content</description></item>
    /// <item><description><strong>No read permission:</strong> Renders a disabled password input field that hides the actual select options and current value</description></item>
    /// </list>
    /// <para>
    /// When rendering a password input (no read permission), the component:
    /// </para>
    /// <list type="bullet">
    /// <item><description>Sets the input type to "password" to mask the content</description></item>
    ...
    /// a select element to maintain security while providing visual feedback that content exists but is restricted.
    /// The original select options and child content are not rendered in this case.
    /// </para>
    /// </remarks>
    protected override void BuildRenderTree(Microsoft.AspNetCore.Components.Rendering.RenderTreeBuilder builder)
    {
        // If the user has read permission, render the base InputSelect component
