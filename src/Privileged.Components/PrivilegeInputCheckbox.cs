...
/// <summary>
/// A custom input checkbox component that integrates privilege-based access control with forms.
...
/// <remarks>
/// <para>
/// This component extends the standard <see cref="InputCheckbox"/> component to provide privilege-aware
...
/// <item><description>Hides the checkbox when read permission is denied (renders nothing)</description></item>
/// <item><description>Disables the checkbox when update permission is denied but read permission is granted</description></item>
/// <item><description>Inherits all standard InputCheckbox functionality when permissions are granted</description></item>
/// </list>
/// <para>
...
public class PrivilegeInputCheckbox : InputCheckbox
{
    ...
    /// </value>
    /// <remarks>
    /// The subject typically represents the entity or resource type being accessed (e.g., "User", "Setting", "Permission").
    /// </remarks>
    [Parameter]
    ...
    /// representing the specific boolean field or property being accessed (e.g., "IsActive", "IsEnabled", "IsPublic", "IsAdmin").
    /// </remarks>
    [Parameter]
    ...
    /// </value>
    /// <remarks>
    /// This action is used to determine if the user can view the checkbox and its current state.
    ...
    /// </value>
    /// <remarks>
    /// This action is used to determine if the user can toggle the checkbox state.
    ...
    /// </value>
    /// <remarks>
    /// When this property is <c>false</c>, the component does not render the checkbox at all,
    /// effectively hiding its existence and current state from the user.
    /// </remarks>
    ...
    /// </value>
    /// <remarks>
    /// When this property is <c>false</c>, the component adds a disabled attribute to prevent toggling,
    ...
    /// </list>
    /// <para>
    /// If the user lacks update permission, a disabled attribute is automatically added to the checkbox.
    /// If the subject is null, empty, or whitespace, all privileges are assumed to be granted.
    /// </para>
    /// <para>
    /// Note that unlike other input components, checkboxes use the disabled attribute instead of readonly
    /// since HTML checkbox elements do not support the readonly attribute.
    /// </para>
    /// </remarks>
    /// <exception cref="InvalidOperationException">
